...
console.log(exclaimThree('bkdjfk')); 
...
console.log(emailCheck( 'alkslsfjk@lsjfsl')); 
...
//CODE HERE
const frogBuyer = gold => `${parseInt(gold/3)} with ${gold % 3} gold left over`; 
